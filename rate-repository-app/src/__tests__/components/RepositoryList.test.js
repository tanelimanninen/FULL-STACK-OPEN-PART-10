...
describe('RepositoryList', () => {
    describe('RepositoryListContainer', () => {
      it('renders repository information correctly', () => {
        ...
        //expect(firstRepositoryItem).toBeEnabled();
        //expect(secondRepositoryItem).toBeEnabled();

        //CHECK THAT CONTENT MATCHES EXPECTATION
        ...
        expect(secondRepositoryItem).toHaveTextContent("7.2");
